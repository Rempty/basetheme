...
';
        ...
        if (styleid != 0 && styleid == 'video'){
            tagtext = "["+ styleid + " splash_image=\"Path to splash preview image (only for hosted video)\" url=\"Vimeo, youtube, dailymotion or path to mp4\" ogg=\"\" webm=\"\" flv=\"\"  /]";
        }
...
';
        ...
        if (styleid != 0 && styleid == 'socialized' ){
            tagtext = '\
                        ...
                        <li class="email-social"><a href="#">email</a></li>\
                        <li class="pinterest"><a href="#">pinterest</a></li>\
                        <li class="instagram"><a href="#">instagram</a></li>\
                        <li class="photo-500"><a href="#">500px</a></li>\
                        </ul>\
                        [/socialized]\ ';
        }
