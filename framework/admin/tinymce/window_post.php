...
<div id="button_panel" class="panel">
    ...
    <fieldset>
        ...
        <table border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
                <td nowrap="nowrap"><label for="button_target"><?php _e('Button Target: ','highthemes'); ?></label></td>
                <td><input id="button_target" type="checkbox" name="button_target" value="_blank">New Window<br></td>
            </tr>
...
<div id="box_panel" class="panel">
    ...
    <fieldset>
        ...
        <table border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
                <td nowrap="nowrap"><label for="info_title_link"><?php _e('Title Link: ','highthemes'); ?></label></td>
                <td><input type="text" id="info_title_link" name="info_title_link" size="44" /><br /></td>
            </tr>
            <tr>
